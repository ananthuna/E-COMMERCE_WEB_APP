    ...
    return (
        <Box ref={pageTopRef} sx={{
            ...
            <Box sx={{
                ...
                <Typography><b>Your Shopping Cart</b></Typography>
                <Box sx={{
                    display: 'flex',
                    gap: 2,
                    pr: 3
            ...
            <Box sx={{
                ...
                <Box sx={{
                    ...
                    <Address address={address} name={name} number={number} addressError={addressError} setAddressError={setAddressError} />
                ...
                <Box sx={{
                    ...
                    {cart && <TotalPrice address={address} cartitems={cartitems} setAddressError={setAddressError} />}
                </Box>
            </Box>
        </Box>
    )
